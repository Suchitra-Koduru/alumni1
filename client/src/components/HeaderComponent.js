...
function HeaderComponent() {
  ...
  return (
    <>
      <div
        className="d-flex container-fluid fixed-top d-flex align-items-center"
        style={{ height: "60px", backgroundColor: "#6a0dad" }}
      >
        <i class="fa-solid fa-graduation-cap"></i>
        <div
          className="p-2 d-flex align-items-center h1 m-0 text-white"
          onClick={handleHome}
          style={{ fontFamily: "'Srisakdi', cursive", color: "#e0b0ff" }}
        >
          <FontAwesomeIcon icon={faGraduationCap} />
          <span>Memories</span>
        </div>
        <ul
          className="container-fluid d-inline-flex flex-wrap h5 flex-row-reverse py-2 align-items-center m-0 gap-4"
          style={{ listStyleType: "none", flexGrow: 1 }}
        >
          <li
            className="nav-item"
        ...
        <div
          className="container-fluid d-inline-flex flex-wrap flex-row-reverse py-2 align-items-center m-0 w-auto"
...
//     return (
//         <>
//             <div className='d-flex container-fluid fixed-top align-items-center' style={{ height: "60px", backgroundColor: "#6a0dad" }}>
...
//                     <FontAwesomeIcon icon={faGraduationCap} /><span>Memories</span>
//                 </div>
...
//                     <li className='nav-item' onClick={handleSearch} style={{ color: "#e0b0ff" }}>
//                         <FaSearch />
//                     </li>
//                 </ul>
